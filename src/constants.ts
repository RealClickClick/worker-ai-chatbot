...
export const DEBATE_STYLES = ['debate', 'panel', 'collaboration', 'interview', 'brainstorm', 'negotiation', 'cross_examine', 'storytelling'] as const;
export const DEBATE_TOKEN_LIMIT = 800;
export const DEBATE_AI_TIMEOUT = 25000;
export const JUDGE_AI_TIMEOUT = 20000;
export const DEBATE_USER_TIMEOUT = 300000;
export const DEBATE_HISTORY_TRUNCATE = 1200;
